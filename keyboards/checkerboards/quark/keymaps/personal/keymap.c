...
//  ),
    [0] = LAYOUT_ortho_4x12(
        ...
        KC_LCTL,        KC_LALT, KC_LGUI, KC_SPC , _______,    KC_SPC,  KC_SPC,  MO(2), KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT
//        KC_LCTL,        KC_LALT, KC_LGUI, KC_SPC , KC_ENT,    KC_SPC,  KC_SPC,  LO(2, KC_ENT), KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT
    ),
